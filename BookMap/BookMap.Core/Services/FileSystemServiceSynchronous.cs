...
{
    public class FileSystemServiceSynchronous
    {
        ...
        public FileSystemServiceSynchronous(IImageFactory imageFactory)
        {
        ...
        public IImage TryLoadFromFileSystem(string imageName)
        {
        ...
        private IImage LoadFromFileSystemAsync(string imageName)
        {
        ...
        private void SaveImage(ImageItem item)
        {
